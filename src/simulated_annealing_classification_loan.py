...
df = pd.read_csv(pfad + 'loan_train_preprocessed.csv')
...
best_activation_fct, best_layer, best_nodes, best_eval, best_nn = simulated_annealing(NeuronalNetworkClassification, bounds, activation_functions, X_train_tensor, y_train_tensor, X_val_tensor, y_val_tensor, n_iterations, step_size, temp, input_shape = X_train.shape[1], output_shape = 7)
